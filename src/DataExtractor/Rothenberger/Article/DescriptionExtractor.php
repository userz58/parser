...
class DescriptionExtractor implements ExtractorInterface
{
    ...
    const UPLOAD_DIR = '/upload/rothenberger';

    protected string $label = 'Детальное описание';

    //protected string $selector = '.news .detail_wrapper .content-text .introtext[itemprop="description"]';
    protected string $selector = '.news .detail_wrapper .content-text';
    ...
    private function formatText(string $value): string
    {
        ...
        // todo: удалить краткое описание .introtext_wrapper
